...
ActiveRecord::Schema.define(version: 20150106001709) do
  ...
  create_table "inventory_files", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "inventory_file_name",    limit: 255
    t.string   "inventory_content_type", limit: 255
    t.integer  "inventory_file_size"
    t.datetime "inventory_updated_at"
    t.string   "inventory_fingerprint",  limit: 255
  end
